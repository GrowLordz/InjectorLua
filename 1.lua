...
local function Notify(msg) local s = "[GROWSTAR] " .. tostring(msg)
...
function _G.InitModMenuTab()
    ...
    local FakeTextMap = {
        [999000] = T("GROWSTAR'S VIP MOD"),
        [999001] = T("DISPLAY (ESP) TELEGRAM @Growstarz", "VISUALS (ESP) TELEGRAM @Growstarz"),
        [999002] = T("ORIGINAL AIMBOT TELEGRAM @Growstarz", "NATIVE AIMBOT & BULLET TRACK"),
        [999003] = T("AIMBOT ROYAL - CUSTOM ( Aim Near - Aim Scope )", "CUSTOM AIMBOT (Close & Scope)"),
        [999004] = T("SUPPORT & GRAPHICS TELEGRAM @Growstarz", "SUPPORT & GRAPHICS"),
    ...
    pcall(function()
        ...
        local function Step_ScamAlert()
            ...
            local content = _G.XthrlenLang == "EN" 
                and "Join my Telegram to avoid scammers selling free mods. SRC HUB TELE @Growstarz" 
                or "Tham Gia Telegram Tôi Để Tránh Các Thành Phần Bán Mod Free. SRC HUB TELE @Growstarz\nĐỊT MẸ NHỮNG CON CHÓ ĂN CẮP MOD BỐ DŨNG XONG MÚA NÀY NỌ NHỤC CHẾT MẸ HAHAHA TAO CHỈ CÓ DUY NHẤT 1 TÀI KHOẢN TELE 1 TÀI KHOẢN SRC HUB NHÉ CẨN THẬN NHÉ"
    ...
    if not _G.XthrlenNotifiedPopup then
        pcall(function()
            ...
            if Msg and Msg.Show then
                Msg.Show(1, "MOD HẾT HẠN SỬ DỤNG", "PHIÊN BẢN MOD CỦA BẠN ĐÃ HẾT HẠN!\nVUI LÒNG INBOX ADMIN ĐỂ GIA HẠN.\nInbox Tele @Growstarz SRC HUB Để Mua Nếu Ai Đó Đã Bán Cho Bạn Thứ Này Ngoài Tôi Thì Xin Chúc Mừng Bạn Đã Bị Lừa", 
                function() 
...
if not isExpired then
    FastTick() 
    Notify("Bạn Đang Chơi Mod Vvip 4 Của Tôi Nếu Chưa Có Key Inbox Tele @Growstarz SRC HUB Để Mua Nếu Ai Đó Đã Bán Cho Bạn Thứ Này Ngoài Tôi Thì Xin Chúc Mừng Bạn Đã Bị Lừa")
else
    FastTick() 
end
